# CSS 수정완료(롤링 텍스트)
텍스트가 한쪽 방향으로 계속해서 흐르는 효과를 적용하고 싶어서 라이브러리를 검색했습니다.
검색 결과 두 가지 방법을 찾게 되었습니다.
...
자바스크립트 라이브러리 적용 숙제라서 자바스크립트를 적용해보려고 했지만...
제가 적용해야 할 롤링 텍스트는 CJFOODVIILE 이라는 한 단어뿐이라서
왠지 간편해보이는 2번(CSS만 활용)을 선택해 수정하게 되었습니다.....🤣

두 가지가 무엇이 다른지 한 번 천천히 살펴보려고 합니다.. :D.....
